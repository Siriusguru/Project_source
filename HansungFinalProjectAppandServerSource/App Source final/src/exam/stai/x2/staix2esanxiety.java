...
public class staix2esanxiety extends Activity {
	TextView sum;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.staix2esanxiety);
		...
		*/
		...
		sum.setText(Html.fromHtml("<font color=#000000>"+"당신의 총점은 [" +"</font>"+ "<b>"+"<font color=#ff0000>" + resultsum + "</font>" + "</b>" + "<font color=#000000>"+ "] 입니다.\n"
		+ "당신의 현재 심리 상태는 " +"</font>"+ "<b><font color=#ff0000>특성불안 수준이 매우 높음.</font></b>" +"<font color=#000000>"+ " 입니다.\n"
		+ "당신의 불안 상태를 해결해줄 노래를 추천해드립니다.\n" + "(노래는 항시 업데이트 됩니다.)"+"</font>"));
		// 웹브라우저에서 텍스트 받아오기
	...
	private class LongRunningGetIO extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			//이것도 발표했으면 좋겠다.
			HttpGet httpGet = new HttpGet("http://baibecktest.appspot.com/item?q=staix2esanxiety&item-searchby=product");
			String text = null;
			try {
		...
		protected void onPostExecute(String results) {
			if (results != null) {
				...
				//}
					...
					Toast.makeText(staix2esanxiety.this, e.getMessage(),
