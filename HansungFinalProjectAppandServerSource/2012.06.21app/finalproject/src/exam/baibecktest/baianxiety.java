...
public class baianxiety extends Activity {
	TextView sum;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		*/
		...
		+ "당신의 현재 심리 상태는 " +"</font>"+ "<b><font color=#ff0000>불안 상태</font></b>" +"<font color=#000000>"+ " 입니다.\n"
	...
	private class LongRunningGetIO extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			//이것도 발표했으면 좋겠다.
			HttpGet httpGet = new HttpGet("http://baibecktest.appspot.com/item?q=baianxiety&item-searchby=product");
			String text = null;
			try {
		...
		protected void onPostExecute(String results) {
			if (results != null) {
				...
				//}
					...
					Toast.makeText(baianxiety.this, e.getMessage(),
