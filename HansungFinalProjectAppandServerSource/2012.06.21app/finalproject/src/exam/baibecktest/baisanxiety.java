...
public class baisanxiety extends Activity {
	TextView sum;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sum.setText(Html.fromHtml("<font color=#000000>" + "당신의 총점은 ["
				...
				+ "당신의 현재 심리 상태는 " + "</font>"
				+ "<b><font color=#ff0000>심한 불안 상태</font></b>"
	...
	private class LongRunningGetIO extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			HttpGet httpGet = new HttpGet(
					"http://baibecktest.appspot.com/item?q=baisanxiety&item-searchby=product");
			String text = null;
			try {
		...
		protected void onPostExecute(String results) {
			if (results != null) {
				...
				try {
					...
					Toast.makeText(baisanxiety.this, e.getMessage(),
